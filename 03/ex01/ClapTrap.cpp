...
/*   Updated: 2023/11/29 12:30:04 by aehrlich         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << "ClapTrap: " << _name << " called name constructor" << std::endl;
}
...
ClapTrap&	ClapTrap::operator=(const ClapTrap& c)
{
	if (this != &c)
	{
		...
		std::cout << "ClapTrap: " << _name << " called copy assignment constructor" << std::endl;
	}
	return (*this);
}
