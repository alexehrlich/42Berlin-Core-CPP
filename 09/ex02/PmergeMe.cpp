...
/*   Updated: 2024/01/12 09:54:36 by aehrlich         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	PmergeMe::printResults()
{
	...
	double vectorTime = static_cast<double>(_endTimeVec - _startTimeVec) / (CLOCKS_PER_SEC * 1000000);
	double dequeTime = static_cast<double>(_endTimeDeque - _startTimeDeque) / (CLOCKS_PER_SEC * 1000000);
